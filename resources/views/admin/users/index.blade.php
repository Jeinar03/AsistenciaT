...
<head>
    ...
    <title>AsistenciaT — Usuarios</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .user-info-name { font-weight: 500; color: white; }
        .user-info-email { font-size: 12px; color: rgba(255,255,255,0.4); margin-top: 2px; }
        .badge {
        ...
        .pagination .page-link {
            padding: 8px 14px; border-radius: 8px; margin: 0 2px;
            background: rgba(255,255,255,0.06);
            border: 1px solid rgba(255,255,255,0.1);
            color: rgba(255,255,255,0.6); text-decoration: none;
    ...
    <main class="main">
        <div class="page-header">
            <div>
                ...
                <div class="page-subtitle">Administra todos los usuarios del sistema</div>
            </div>
            ...
            <table>
                ...
                <tbody id="usersTable">
                    ...
                    <tr>
                        ...
                        <td style="color: rgba(255,255,255,0.6)">{{ $user->matricula ?? '—' }}</td>
                        <td>
