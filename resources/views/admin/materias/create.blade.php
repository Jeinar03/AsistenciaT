...
<head>
    ...
    <title>AsistenciaT — Nueva Materia</title>
...
<div class="layout">
    ...
    <main class="main">
        <div class="page-header">
            <a href="{{ route('admin.materias.index') }}" class="btn-back">
                <svg viewBox="0 0 24 24"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>
                Volver
            </a>
            <div>
                <div class="page-title">Nueva Materia</div>
                <div class="page-subtitle">Registra una nueva materia</div>
            </div>
        </div>
        <div class="form-card">
            <form method="POST" action="{{ route('admin.materias.store') }}">
                ...
                <div class="form-grid">
                    <div class="form-group full">
                        ...
                        <select name="carrera_id" class="form-select {{ $errors->has('carrera_id') ? 'is-invalid' : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="creditos"
                               class="form-input {{ $errors->has('creditos') ? 'is-invalid' : '' }}"
                               value="{{ old('creditos', 0) }}"
                               min="0" max="20">
                    ...
                    <div class="form-group full">
                        ...
                        <input type="text" name="nombre"
                               ...
                               value="{{ old('nombre') }}"
                               placeholder="Ej: Análisis y Explotación de Datos">
