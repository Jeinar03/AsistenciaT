...
<head>
    ...
    <title>AsistenciaT — Editar Materia</title>
...
<div class="layout">
    ...
    <main class="main">
        <div class="page-header">
            ...
            <div>
                <div class="page-title">Editar Materia</div>
                <div class="page-subtitle">{{ $materia->nombre }}</div>
            </div>
        </div>
        <div class="form-card">
            <form method="POST" action="{{ route('admin.materias.update', $materia) }}">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="creditos" class="form-input"
                               value="{{ old('creditos', $materia->creditos) }}" min="0" max="20">
                    </div>
                    <div class="form-group full">
                    ...
                    <div class="form-group full">
                        ...
                        <div class="toggle-group">
                            ...
                            <span class="toggle-label">Materia activa</span>
                        </div>
                    </div>
                </div>
