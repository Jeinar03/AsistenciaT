...
<div class="layout">
    ...
    <main class="main">
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                <div class="stat-num" style="color:#6ee7b7">
                    {{ $logs->getCollection()->where('accion', 'crear')->count() }}
                </div>
                <div class="stat-lbl">Creaciones</div>
            </div>
            <div class="stat-card">
                <div class="stat-num" style="color:#93c5fd">
                    {{ $logs->getCollection()->where('accion', 'editar')->count() }}
                </div>
                <div class="stat-lbl">Ediciones</div>
            </div>
            <div class="stat-card">
                <div class="stat-num" style="color:#fca5a5">
                    {{ $logs->getCollection()->where('accion', 'eliminar')->count() }}
                </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" class="empty-state">
                            ...
                            <small style="font-size:13px">Los registros aparecerán cuando el sistema detecte actividad.</small>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
