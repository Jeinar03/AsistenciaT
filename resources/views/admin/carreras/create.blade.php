...
<head>
    ...
    <title>AsistenciaT — Nueva Carrera</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-hint { font-size: 12px; color: rgba(255,255,255,0.35); }
        .form-input {
...
<div class="layout">
    ...
    <main class="main">
        <div class="page-header">
            <a href="{{ route('admin.carreras.index') }}" class="btn-back">
                <svg viewBox="0 0 24 24"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>
                Volver
            </a>
            <div>
                <div class="page-title">Nueva Carrera</div>
                <div class="page-subtitle">Registra una nueva carrera</div>
            </div>
        </div>
        <div class="form-card">
            <form method="POST" action="{{ route('admin.carreras.store') }}">
                ...
                <div class="form-group">
                    <label class="form-label">Clave de la carrera *</label>
                    <input type="text" name="clave"
                           class="form-input {{ $errors->has('clave') ? 'is-invalid' : '' }}"
                           value="{{ old('clave') }}"
                           placeholder="Ej: ISC, IDS, LAE"
                           style="text-transform: uppercase">
                    <span class="form-hint">Se guardará en mayúsculas automáticamente</span>
                    @error('clave')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="form-group">
                    <label class="form-label">Nombre completo de la carrera *</label>
