...
<head>
    ...
    <title>AsistenciaT — Editar Carrera</title>
...
<div class="layout">
    ...
    <main class="main">
        <div class="page-header">
            ...
            <div>
                <div class="page-title">Editar Carrera</div>
                <div class="page-subtitle">{{ $carrera->nombre }}</div>
            </div>
        </div>
        <div class="form-card">
            <form method="POST" action="{{ route('admin.carreras.update', $carrera) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-group">
                        ...
                        <span class="toggle-label">Carrera activa</span>
                    </div>
                </div>
