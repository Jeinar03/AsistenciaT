...
<head>
    ...
    <title>AsistenciaT — Carreras</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .carrera-cell { display: flex; align-items: center; gap: 12px; }
        .carrera-icon {
        ...
        .carrera-nombre { font-weight: 500; }
        .carrera-clave { font-size: 12px; color: rgba(255,255,255,0.4); margin-top: 2px; }
        .badge-activo {
            background: rgba(16,185,129,0.2); border: 1px solid rgba(16,185,129,0.4);
            border-radius: 20px; padding: 4px 10px; font-size: 11px; font-weight: 600; color: #6ee7b7;
        }
        .badge-inactivo {
            background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15);
            border-radius: 20px; padding: 4px 10px; font-size: 11px; font-weight: 600; color: rgba(255,255,255,0.4);
        }
        .badge-materias {
            background: rgba(99,102,241,0.2); border: 1px solid rgba(99,102,241,0.3);
            border-radius: 20px; padding: 4px 10px; font-size: 11px; font-weight: 600; color: #a78bfa;
        }
...
<div class="layout">
    <aside class="sidebar">
        ...
        <a href="{{ route('admin.carreras.index') }}" class="sidebar-item active">
    ...
    <main class="main">
        <div class="page-header">
            <div>
                ...
                <div class="page-subtitle">Gestiona las carreras de la institución</div>
            </div>
            <a href="{{ route('admin.carreras.create') }}" class="btn-primary">
        ...
        <div class="table-card">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="carrera-cell">
                                <div class="carrera-icon">{{ substr($carrera->clave, 0, 2) }}</div>
                                <div>
                                    <div class="carrera-nombre">{{ $carrera->nombre }}</div>
                                    <div class="carrera-clave">{{ $carrera->clave }}</div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="badge-materias">{{ $carrera->materias_count }} materias</span>
                        </td>
                        <td>
                            <span class="{{ $carrera->activo ? 'badge-activo' : 'badge-inactivo' }}">
                        ...
                        <td>
                            <div class="actions">
                                <a href="{{ route('admin.carreras.edit', $carrera) }}" class="btn-edit">Editar</a>
