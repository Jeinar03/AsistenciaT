...
<head>
    ...
    <title>AsistenciaT — Nuevo Semestre</title>
...
<div class="layout">
    ...
    <main class="main">
        <div class="page-header">
            ...
            <div>
                <div class="page-title">Nuevo Semestre</div>
                <div class="page-subtitle">Registra un nuevo período escolar</div>
            </div>
        </div>
        <div class="form-card">
            <form method="POST" action="{{ route('admin.semestres.store') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-group">
                        ...
                        <span class="toggle-label">Marcar como semestre activo</span>
                    </div>
                </div>
                <div class="form-actions">
                    <a href="{{ route('admin.semestres.index') }}" class="btn-secondary">Cancelar</a>
                    <button type="submit" class="btn-primary">Crear Semestre</button>
                </div>
            </form>
        </div>
    </main>
