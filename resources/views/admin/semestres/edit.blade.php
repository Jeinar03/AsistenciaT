...
<head>
    ...
    <title>AsistenciaT — Editar Semestre</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-back {
            ...
            padding: 8px 14px; font-size: 13px; text-decoration: none; transition: all 0.2s;
        }
...
<div class="layout">
    ...
    <main class="main">
        <div class="page-header">
            <a href="{{ route('admin.semestres.index') }}" class="btn-back">
                <svg viewBox="0 0 24 24"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>
                Volver
            </a>
            <div>
                <div class="page-title">Editar Semestre</div>
                <div class="page-subtitle">{{ $semestre->nombre }}</div>
            </div>
        </div>
        <div class="form-card">
            <form method="POST" action="{{ route('admin.semestres.update', $semestre) }}">
                @csrf @method('PUT')
                <div class="form-group">
                    <label class="form-label">Nombre del semestre *</label>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_inicio"
                               class="form-input {{ $errors->has('fecha_inicio') ? 'is-invalid' : '' }}"
                               value="{{ old('fecha_inicio', $semestre->fecha_inicio->format('Y-m-d')) }}">
                        @error('fecha_inicio')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label">Fecha de fin *</label>
                        <input type="date" name="fecha_fin"
                               class="form-input {{ $errors->has('fecha_fin') ? 'is-invalid' : '' }}"
                               value="{{ old('fecha_fin', $semestre->fecha_fin->format('Y-m-d')) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-group">
                        ...
                        <span class="toggle-label">Semestre activo</span>
                    </div>
                </div>
                <div class="form-actions">
                    <a href="{{ route('admin.semestres.index') }}" class="btn-secondary">Cancelar</a>
