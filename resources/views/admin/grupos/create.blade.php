...
<head>
    ...
    <title>AsistenciaT — Nuevo Grupo</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-remove-horario:hover { background: rgba(239,68,68,0.35); }
        .btn-add-horario {
        ...
        .btn-add-horario:hover { background: rgba(99,102,241,0.35); color: white; }
...
<div class="layout">
    ...
    <main class="main">
        <div class="page-header">
            ...
            <div>
                <div class="page-title">Nuevo Grupo</div>
                <div class="page-subtitle">Configura el grupo, horario y sesiones</div>
            </div>
        </div>
        <div class="form-card">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="clave" class="form-input"
                               value="{{ old('clave') }}" placeholder="Ej: 81T"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="max_alumnos" class="form-input"
                               value="{{ old('max_alumnos', 35) }}" min="1" max="100">
                    </div>
                    <div class="form-group">
                        <label class="form-label">% Asistencia mínima *</label>
                        <input type="number" name="porcentaje_asistencia_minima" class="form-input"
                               value="{{ old('porcentaje_asistencia_minima', 80) }}"
                               min="0" max="100" step="0.01">
                    </div>
                </div>

                <div class="section-title">🕐 Horarios del grupo</div>
                <div id="horariosContainer">
                    <div class="horario-row">
                        <div class="horario-grid">
                            <div class="form-group" style="margin:0">
                                <label class="form-label">Día</label>
                                <select name="horarios[0][dia]" class="form-select">
                            ...
                            <div class="form-group" style="margin:0">
                                ...
                                <input type="time" name="horarios[0][hora_inicio]" class="form-input" value="07:00">
                            </div>
                            <div class="form-group" style="margin:0">
                                <label class="form-label">Fin</label>
                                <input type="time" name="horarios[0][hora_fin]" class="form-input" value="09:00">
                            </div>
                            <div class="form-group" style="margin:0">
                                <label class="form-label">Aula</label>
                                <input type="text" name="horarios[0][aula]" class="form-input" placeholder="Ej: A101">
                            </div>
