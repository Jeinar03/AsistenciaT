...
<head>
    ...
    <title>AsistenciaT — Grupos</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .grupo-info { font-size: 13px; color: rgba(255,255,255,0.5); margin-bottom: 4px; }
        .grupo-stats {
    ...
    <main class="main">
        <div class="page-header">
            <div>
                ...
                <div class="page-subtitle">Gestiona los grupos por materia y semestre</div>
            </div>
            <a href="{{ route('admin.grupos.create') }}" class="btn-primary">
        ...
        <div class="grupos-grid">
            ...
            <div class="grupo-card">
                <div class="grupo-header">
                    ...
                    <span class="{{ $grupo->activo ? 'badge-activo' : 'badge-inactivo' }}">
                        {{ $grupo->activo ? 'Activo' : 'Inactivo' }}
                    </span>
                </div>
                <div class="grupo-materia">{{ $grupo->materia->nombre }}</div>
                <div class="grupo-info">📚 {{ $grupo->materia->clave }}</div>
                <div class="grupo-info">👨‍🏫 {{ $grupo->maestro->name }}</div>
                <div class="grupo-info">📅 {{ $grupo->semestre->nombre }}</div>
                <div class="grupo-stats">
                    <div class="stat-item">
                        <div class="stat-num">{{ $grupo->alumnos->count() }}</div>
                        <div class="stat-lbl">Alumnos</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-num">{{ $grupo->max_alumnos }}</div>
                        <div class="stat-lbl">Máx</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-num">{{ $grupo->porcentaje_asistencia_minima }}%</div>
                        <div class="stat-lbl">Asist. min</div>
                    </div>
                </div>
            ...
            @empty
            <div class="empty-state">👥 No hay grupos registrados aún.</div>
            @endforelse
        </div>
    </main>
</div>
